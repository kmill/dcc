...
the code generator portion of the loop parallelizer. Alec Thomson wrote all of
...
dominator spectrum of the midir. To do so, we used a simple forwards
...
The dominator spectrum produced by this analysis was then a map from
block labels to the sets of dominators of those blocks. The dominator
spectrum proved essential to the discovery of loops, loop induction
...
specifically designed tests (such as matrix multiply). 
